...
/**
 * The books being read now, shelved as a row of covers rather than laid out as
 * cards.
 *
 ...
 * lot of chrome for what is really a short list of covers. The artwork alone
 * says it, which is what a reader recognises their own books by, and the note
 * stays on the book page where it is edited.
 *
